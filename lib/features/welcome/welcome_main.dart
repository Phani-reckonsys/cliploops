...
class WelcomeMain extends StatefulWidget {
  const WelcomeMain({super.key, required this.title});
  final String title;
  ...
  final List<Map<String, String>> _welcomeContent = const [
    {
      ...
      'description': 'Cut, loop, and tweak your music with ease! Get creative and make your sound totally your own!',
    },
    {
                ...
                child: Padding(
                  ...
                  child: FractionallySizedBox(
                    ...
                    child: FilledRedButton(
                      text: "Get Started",
                      onPressed: () {
                        print("Button tapped at ${DateTime.now().toIso8601String()} in Bengaluru!");
                      },
                    ),
                  ),
                ),
